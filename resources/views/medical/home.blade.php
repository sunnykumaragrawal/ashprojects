...
<head>
  ...
  <title>Best Medical Websites For Your Clinic</title>
  <!-- Favicons -->
...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <div class="logo" style="float: left;">
        <a href="https://agrawalsoftwarehouse.com/"><img src="{{asset('assets/img/logo.png')}}" class="img-fluid"></a>
      </div>
      ...
      <nav class="nav-menu">
        <ul>
          <li><a href="https://agrawalsoftwarehouse.com/" class="nav-title"><img src="{{asset('assets/img/logo.png')}}" class="img-fluid"></a></li>
          <li class="active"><a href="https://agrawalsoftwarehouse.com/#hero"><img src="{{asset('assets/img/medical/home/nav/home.png')}}" class="img-fluid"><span>Home</span></a></li>
          <li><a href="https://agrawalsoftwarehouse.com/#about"><img src="{{asset('assets/img/medical/home/nav/about.png')}}" class="img-fluid"><span>About Us</span></a></li>
          <li><a href="https://agrawalsoftwarehouse.com/#why-us"><img src="{{asset('assets/img/medical/home/nav/why.png')}}" class="img-fluid"><span>Why Us</span></a></li>
        ...
        <div class="col-lg-6 order-lg-1 order-2">
          <div class="owl-carousel hero-carousel">
            <div class="hero-content">
              <p>AGRAWAL SOFTWARE HOUSE</p>
              <h1>We provide best website for your Business</h1>
              <a href="https://templates.agrawalsoftwarehouse.com/" target="_blank" class="template-btn1 hero-btn1">Get Started</a>
              <a href="https://agrawalsoftwarehouse.com/#about" class="template-btn2 hero-btn2">Learn More</a>
            </div>
            <div class="hero-content">
              <p>AGRAWAL SOFTWARE HOUSE</p>
              <h1>Best web services In India</h1>
              <a href="https://agrawalsoftwarehouse.com/#services" class="template-btn1 hero-btn1">View Services</a>
              <a href="https://agrawalsoftwarehouse.com/#pricing" class="template-btn2 hero-btn2">Check Pricing</a>
            </div>
            <div class="hero-content">
              <p>AGRAWAL SOFTWARE HOUSE</p>
              <h1>Make a website for your Business</h1>
              <a href="https://templates.agrawalsoftwarehouse.com/" target="_blank" class="template-btn1 hero-btn1">Let's Start</a>
              <a href="https://agrawalsoftwarehouse.com/#team" class="template-btn2 hero-btn2">Contact Now</a>
            </div>
          </div>
        </div>
    ...
    <section>
      <div class="container">
        <div class="section-title">
          <h2>Best Medical Websites for your clinic or hospital</h2>
          <p></p>
        </div>
        <div class="row">
          <div class="col-md-6">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6">
            ...
            <div class="d-flex ">
              <ul>
                <li><a href="https://agrawalsoftwarehouse.com/#hero">Home</a></li>
                <li><a href="https://agrawalsoftwarehouse.com/#services">Services</a></li>
                <li><a href="https://agrawalsoftwarehouse.com/#pricing">Pricing</a></li>
              </ul>
            </div>
          </div>
          <div class="col-lg-3 col-md-6">
            ...
            <div class="d-flex ">
              <ul>
                <li><a href="https://templates.agrawalsoftwarehouse.com/medical" target="_blank">Medical</a></li>
              </ul>
            </div>
          </div>
        ...
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center align-items-lg-baseline">
          <div class="social-box">
            <a href="https://www.facebook.com/agrawalsoftwarehouse/" target="_blank" class="facebook-bg"><i class="icofont-facebook"></i></a>
            <a href="https://www.linkedin.com/company/agrawal-software-house/" target="_blank" class="twitter-bg"><i class="icofont-linkedin"></i></a>
            <a href="https://www.Instagram.com/agrawalsoftware" target="_blank" class="instagram-bg"><i class="icofont-instagram"></i></a>
          </div>
  ...
  <script src="{{asset('assets/js/medical/home.js')}}"></script>
